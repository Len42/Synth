...
### Features
- Input: Eurorack jacks for left & right channels, with left normalled to right for mono
- Headphone output: 3.5 mm stereo headphone jack
- Balanced stereo line output: 3.5 mm TRS jacks for left & right channels. Requires two cables with 3.5 mm TRS plug on one end and either 1/4 inch TRS or XLR on the other end.
